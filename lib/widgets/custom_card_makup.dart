...
class CustomCardMakeUpWidgets {
      ...
      children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return buildCardmakeUp(context, item, data); // ✅ fixed: removed cast
          },
        ),
      ],
    );
  ...
  static Widget buildCardmakeUp(BuildContext context, Map<String, String> item, List<Map<String, String>> makeupHair) {
