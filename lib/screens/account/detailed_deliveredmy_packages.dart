...
class DetailedDeliveredmyPackagesScreen extends StatefulWidget {
  ...
  const DetailedDeliveredmyPackagesScreen({ Key? key, required this.package,}) : super(key: key);

  @override
  State<DetailedDeliveredmyPackagesScreen> createState() => _DetailedDeliveredmyPackagesScreen();
}

class _DetailedDeliveredmyPackagesScreen extends State<DetailedDeliveredmyPackagesScreen> {
  ...
  // const Text(
  // "Bill Details",
  // style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14, color: Color(0XFF575959)),
  ...
  Text(service["price"]!,
    style: TextStyle(fontSize: 12, color: Color(0XFF1E535B),fontWeight: FontWeight.w600)),
  const Text("Delivered on–23–03–25",
  style: TextStyle(fontSize: 12, color: Color(0XFF757575),fontWeight: FontWeight.w400)),
  ],
  ),
  ),
  ],
  ...
  5,
  (index) =>  Padding(
    padding: const EdgeInsets.symmetric(horizontal: 18), // 👈 Adjust the gap here
    child: Icon(
